...
import (
	...
	"github.com/Aoi020608/bookings/internal/driver"
	"github.com/Aoi020608/bookings/internal/forms"
	...
	"github.com/Aoi020608/bookings/internal/repository"
	"github.com/Aoi020608/bookings/internal/repository/dbrepo"
...
// NewHandlers sets the repositrory for the handlers
...
func (m *Repository) AdminShowPostReservation(w http.ResponseWriter, r *http.Request) {
	...
	m.App.Session.Put(r.Context(), "flash", "CHnages saved")
	http.Redirect(w, r, fmt.Sprintf("/admin/reservations-%s", src), http.StatusSeeOther)
}

func (m *Repository) AdminReservationsCalendar(w http.ResponseWriter, r *http.Request) {
	// assume that there is no month/year spwcified
	now := time.Now()
	...
	for _, x := range rooms {
		...
		// get all restrictiosn for the current room
...
func (m *Repository) AdminDeleteReservation(w http.ResponseWriter, r *http.Request) {
	...
	m.App.Session.Put(r.Context(), "flash", "Delte successfully")
